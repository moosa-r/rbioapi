...
rba_ensembl_Archive = function(id,
  ...
  invisible(rba_ba_arguments_check(cons = list(list(arg = id,
                                                    name = id,
                                                    class = "character",
                                                    max_len = 1000),
                                               list(arg = verbose,
...
rba_ensembl_xrefs_symbol = function(external_symbol,
                                    ...
                                    diagnostics = FALSE) {
  ## Check input arguments
  invisible(rba_ba_arguments_check(cons = list(list(arg = external_symbol,
...
rba_ensembl_xrefs_id = function(ensembl_id,
                                ...
                                diagnostics = FALSE) {
  ## Check input arguments
  invisible(rba_ba_arguments_check(cons = list(list(arg = ensembl_id,
                                                    name = "ensembl_id",
                                                    class = "character",
                                                    len = 1),
                                               list(arg = species,
