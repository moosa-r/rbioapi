...
Using this function you can retrieve nodes that are located in the top
or the bottom of your supplied node in [UniProt Taxonomy database
tree](https://www.uniprot.org/help/taxonomy)
...
- depth:
  ...
  (numeric) How many levels should be traversed on the taxonomic tree?
  (from 1 to 5, default = 5)
