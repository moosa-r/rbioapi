...
Most of rbioapi UniProt functions have to variants. one to retrieve data using a proper accession, and the second one (which have a `_search` suffix) is to search using any combination of arguments. We first demonstrate this using an example, then provide a list of such functions in rbioapi.
...
## 1 As the simplest scenario, we can retreive multiple proteins in one call
