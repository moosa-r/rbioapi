...
You can retrieve a list of interactions the proteins in your set have with each other. STRING annotates each interaction. Two of the annotated attributes can be used in the function call to filter the results (required_score, network_type); Other attributes correspond to the columns which the data frame returns.
...
# althoug we provide only one protein ID here (CD40 protein), you can provide a vector of proteins as the input
...
annotations <- rba_string_annotations(ids = proteins_mapped,
                                     species = 9606)
```

```{r rba_string_annotations_restults, echo=FALSE}
DT::datatable(data = annotations,
              style = "bootstrap4",
              options = list(scrollX = TRUE, 
                             paging = TRUE,
                             fixedHeader = TRUE,
