...
3.  [miEAA](https://ccb-compute2.cs.uni-saarland.de/mieaa/ "miRNA Enrichment Analysis and Annotation Tool (miEAA)") ([rbioapi vignette article](rbioapi_mieaa.html "rbioapi & miEAA vignette article"))
...
# Saving API request metadata {#api-request-metadata}
...
```{r rba_metadata_access, eval=FALSE}
...
-   [How to cite miEAA](rbioapi_mieaa.html#citations "How to cite miEAA"). (See the [miEAA website](https://ccb-compute2.cs.uni-saarland.de/mieaa/).)
