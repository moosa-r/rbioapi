...
Directly quoting the the latest paper published by PANTHER (Protein ANalysis THrough Evolutionary Relationships) authors:
...
>
> (reference: Mi, Huaiyu, et al. "Protocol Update for large-scale genome and gene function analysis with the PANTHER classification system (v. 14.0)." *Nature protocols* 14.3 (2019): 703-721)

The provided tools in PANTHER's **RESTful API services** can be divided into 3 broad categories: Mapping genes, retrieving information and research tools. Herein, we provided a very short introduction; you can always check functions' manuals for in-depth guide.

------------------------------------------------------------------------

## Map genes {#map-genes .heading2}

-   `rba_panther_mapping()`: map your gene-set to PANTHER database and retrieve attributes and annotations associated to your genes
