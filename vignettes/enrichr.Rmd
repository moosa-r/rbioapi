...
Just fill the arguments of `rba_enrichr_wrp` according to the function's manual; Simply provide your gene-set as a character vector and select the libraries.
...
But when multiple libraries has been selected, the function's output will be a list where each element is a data frame corresponding to one of the selected libraries:
...
As you can see in `rba_enrichr_wrp()`'s name, it is a wrapper function. It basically executes the following sequence of functions:
